...
from common.shared_config import x_bearer_token
from common.utils import extract_by_regex
...
class X(SearchAPI):
    """The X (Twitter) API class. Requires "Basic" API access to work. For more info, see
